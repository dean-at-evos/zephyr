...
static inline void ctf_top_heap_free(uint32_t h, uint32_t free, uint32_t alloc, uint32_t max_alloc)
{
	CTF_EVENT(CTF_LITERAL(uint8_t, CTF_EVENT_HEAP_FREE), h, free, alloc, max_alloc);
}
